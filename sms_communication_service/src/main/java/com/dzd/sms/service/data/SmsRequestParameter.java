...
public class SmsRequestParameter implements Serializable {
	...
	public int getBefroBillingNum()
	{
		return befroBillingNum;
	}

	public void setBefroBillingNum(int befroBillingNum)
	{
		this.befroBillingNum = befroBillingNum;
	}
	...
	public boolean isTimeTaskCeck()
	{
		return timeTaskCeck;
	}

	public void setTimeTaskCeck(boolean timeTaskCeck)
	{
		this.timeTaskCeck = timeTaskCeck;
	}
