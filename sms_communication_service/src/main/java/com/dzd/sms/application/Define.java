...
/**
 * Created by IDEA Author: WHL Date: 2017/1/4 Time: 19:41
 */
public class Define {
	...
	// 发送号码队列， 用于数据库保存
	// public final static String KEY_SMS_TASK_MESSAGE_DB =
	// "sms_task_message_db";
	...
	public final static int STATE_SENDING = 99; // 已提交，运营商没有返回值 0 改成99
												// 提交后就等运营商返回状态
	...
	public final static SmsState INTERFACE_STATE_NONE_AISLE_GROUP_TYPE_ERROR = SmsState.define(13,
			"通道发送类型不匹配(参数：type值和通道值不匹配).");
	// 查询帐户余额
	...
	public interface REQUESTPARAMETER {
		...
		String DATE_EXPORT = "date_export";
		String SESSION_USER = "session_user";
		String SORTVAL = "sortVal";
		String EMAIL = "email";
		...
		String SYSUSERIDS = "sysUserIds";
		String SMSUSERVAL = "smsUserVal";
		String UID = "uid";
		...
		String BEFROBILLINGNUM = "befroBillingNum";
	...
	public interface USERSENDSMS {
		...
		String SMS_SEND_AISLE_HUIFU = "短信内容的结尾须按要求加退订格式！";
		...
		String SMS_SEND_SYSTEM_ERROR = "服务器异常,请稍后再试.";
	...
	// 菜单url
	public interface MENUURLACTION {
		String AISLECOLUMN = "aisleColumn";
		String NICKNAMECOLUMN = "nickNameColumn";
		String ROLENAMECOLUMN = "roleNameColumn";
		String NICKCOLUMN = "nickColumn";
		String UACCOUNTCOLUMN = "uaccountColumn";
		String MONEYCOLUMN = "moneyColumn";

		// 发送记录
		String SENDLIST_AISLE_COLUMN_URL = "/sendList/aisleSelect.do";// 通道列 url

		// 发送详情、日志记录
		String SENDDETAIL_REPORT_COLUMN_URL = "/sendList/statusReport.do"; // 状态报告
																			// url
		String SENDDETAIL_STATUSTIME_COLUMN_URL = "/sendList/statusTime.do";// 状态时间

		// 定时任务
		String TIMING_BELONG_COLUMN_URL = "/smsTimedTask/aisleSelect.do"; // 通道列
																			// url

		// 今日统计
		String TODAYSTATISTICAL_AISLE_COLUMN_URL = "/todayStatistical/aisleSelect.do";// 通道列
																						// url
		String TODAYSTATISTICAL_BELONG_COLUMN_URL = "/todayStatistical/nickSelect.do";// 归属列
																						// url

		// 充值记录
		String RECHARGE_ACCOUNT_COLUMN_URL = "/puserBill/account.do";// 操作者列 url
		String RECHARGE_MONEY_COLUMN_URL = "/puserBill/money.do";// 金额列 url
		String RECHARGE_BELONG_COLUMN_URL = "/puserBill/belong.do";// 账户归属 url

		// 消费记录
		String CONSUME_BELONG_COLUMN_URL = "/puserConsume/belong.do";// 账户归属 url

		// 短信账户管理
		String SMSACCOUNT_AISLE_COLUMN_URL = "/apply/from/aisleType.do";// 通道列
																		// url
		String SMSACCOUNT_BID_COLUMN_URL = "/apply/from/bid.do";// 归属列 url

		// 账户管理
		String SYSACCOUNT_AISLE_COLUMN_URL = "/management/aisleGroup.do";// 通道列
																			// url
		String SYSACCOUNT_ROLENAME_COLUMN_URL = "/management/roleName.do";// 用户类型列
																			// url
		String SYSACCOUNT_BELONG_COLUMN_URL = "/management/nickName.do";// 账号归属列
																		// url

		// 短信回复
		String SMSRECEIVEREPLY_AISLE_COLUMN_URL = "/receiveReplyPush/aisleName.do";// 通道列
																					// url
