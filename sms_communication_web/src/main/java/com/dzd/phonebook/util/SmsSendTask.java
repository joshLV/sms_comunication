...
public class SmsSendTask extends BasePage{
	...
	private Date actualSendTime;			//实际发送时间
	...
	private String detailBillingNum;// 发送详情的短信条数
	...
	public String getDetailBillingNum() {
		return detailBillingNum;
	}

	public void setDetailBillingNum(String detailBillingNum) {
		this.detailBillingNum = detailBillingNum;
	}
}
