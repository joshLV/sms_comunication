...
public class PhoneFilterUtil {
     ...
     */
    @SuppressWarnings("unchecked")
    public static Boolean uploadPhoneFilter(List<String> phoneList, String uuid, SysUser user,
                                             SmsFileConfigService<SmsFileConfig> smsFileConfigService) {
        String fileName = "运营商过滤号码dzdqw" + RandomUtil.getRandomTenThousand() + ".txt";
        try {
