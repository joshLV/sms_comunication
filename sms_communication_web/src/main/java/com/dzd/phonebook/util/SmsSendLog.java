...
public class SmsSendLog extends BasePage implements Serializable {
    ...
    private List<Integer> sysUserIds;                //系统用户ID集
    ...
    private int signatureType;                    // 签名类型0：绑定签名  1：自定义签名
    ...
    private String statusReportColumn;// 状态报告列
    private String statusTimeColumn;// 状态时间列
	...
	public Object[] getSignatureAttr() {
        return signatureAttr;
    }

    public void setSignatureAttr(Object[] signatureAttr) {
    ...
    public String getStatusReportColumn() {
        return statusReportColumn;
    }

    public void setStatusReportColumn(String statusReportColumn) {
        this.statusReportColumn = statusReportColumn;
    }
