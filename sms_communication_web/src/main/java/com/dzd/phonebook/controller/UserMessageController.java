...
public class UserMessageController extends WebBaseController {
	public static final LogUtil log = LogUtil.getLogger(UserMessageController.class);
	 ...
	 * "Wed Jul 02 16:00:20 CST 2014"; Date date = parse(str,
	 * "EEE MMM dd HH:mm:ss zzz yyyy", Locale.US);
	 * 
	 * SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	 * String dd = format.format(date); System.out.println("dd>>>>  " + dd); }
	 * 
	 * public static Date parse(String str, String pattern, Locale locale) { if
	 * (str == null || pattern == null) { return null; } try { return new
	 * SimpleDateFormat(pattern, locale).parse(str); } catch (ParseException e)
	 * { e.printStackTrace(); } return null; }
	 * 
	 * public static String format(Date date, String pattern, Locale locale) {
	 * if (date == null || pattern == null) { return null; } return new
