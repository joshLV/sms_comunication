...
public class SmsReport
{
	...
	public String reply(HttpServletRequest request)
	{
		...
		String aisleKey = request.getParameter("key");
		String aisleIdString = request.getParameter("id");
		System.out.println("reply aisleKey=" + aisleKey + " aisleIdString=" + aisleIdString);
		long aisleId = Integer.valueOf(aisleIdString);
		BaseAisle baseAisle = SmsServerManager.I.getAisle(aisleId);
		if ( baseAisle == null )
		{
	 ...
	 * @return
	 */
	@RequestMapping(value = "/replygbk")
	@ResponseBody
	public String replygbk(HttpServletRequest request)
	{
		try {
		...
		String aisleKey = request.getParameter("key");
		String aisleIdString = request.getParameter("id");
		System.out.println("replygbk aisleKey=" + aisleKey + " aisleIdString=" + aisleIdString);
		long aisleId = Integer.valueOf(aisleIdString);
		BaseAisle baseAisle = SmsServerManager.I.getAisle(aisleId);
		if ( baseAisle == null )
		{
