...
function saveif() {  //保存信息
    ...
    if(btnType == "copy" || btnType == "register"){
        id="";
    }
    var data = {
        "email": email
    };
    $("#save_data_btn").addClass("f-btn-dis");
    $("#save_data_btn").attr("disabled", "disabled");
    ajaxCall({
...
$(function () {
    ...
    //查询用户新
    if (btnType =="copy" ||  btnType == "update" || btnType == "register") {
        querySmsUserById();
    }
