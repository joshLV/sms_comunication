...
$(function () {
    ...
    $("#save_data_btn").bind("click", function () {
        ...
        if(i_state == null || i_state == ""){
            alert("请输入通道状态!");
            $("#i_state").focus();
            return;
        }
        var i_smsAisleKey=$("#i_smsAisleKey").val();
        if(i_smsAisleKey == null || i_smsAisleKey == ""){
            alert("请输入通道公司名称!");
            $("#i_smsAisleKey").focus();
            return;
        }
            ...
            if (checkRes(data)) {
                ...
                for (var key in obj) {
                    ...
                    html += '<div class="inp-box">'
                        ...
                        + '<input type="text" class="inp-box-inp addsf ext_' + values["extra"] + '" id="u_' + key + '" name="options" />'
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    if (!row.state || row.state == 1) {
                        ...
                        return "<span style='color:#fd0000'>自动停用</span>";
                    }
                }
            },
            {
