...
formatShowingRows: function (pageFrom, pageTo, totalRows) {
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                	if (index == 0) {
                        return row.sumSucceedNumUs;
                    } else {
                    	return row.succeedNumUs;
                    }	
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                	if (index == 0) {
                        return row.sumSucceedNumMs;
                    } else {
                    	return row.succeedNumMs;
                    }	
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                	if (index == 0) {
                        return row.sumSucceedNumTs;
                    } else {
                    	return row.succeedNumTs;
                    }	
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                	if (index == 0) {
                        return row.sumUnknownSucceedNum;
                    } else {
                    	return row.unknownSucceedNum;
                    }	
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                	if (index == 0) {
                        return row.sumFailureNumUs;
                    } else {
                    	return row.failureNumUs;
                    }	
                }
            },
            {
                ...
                formatter: function (value, row, index) {
                	if (index == 0) {
                        return row.sumFailureNumMs;
                    } else {
                    	return row.failureNumMs;
                    }	
                }
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                	if (index == 0) {
                        return row.sumFailureNumTs;
                    } else {
                    	return row.failureNumTs;
                    }	
                }
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                	if (index == 0) {
                        return row.sumUnknownFailureNum;
                    } else {
                    	return row.unknownFailureNum;
                    }	
                }
            },
            {
