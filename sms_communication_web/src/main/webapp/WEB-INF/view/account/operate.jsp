        ...
        <ul class="form-inp-ul">
            ...
            <li>
                <div class="form-inp-box">
                    ...
                    <select class="province select imp" id="roleName" name="roleName"  style="min-width:200px"
            ...
            <li>
                <div class="form-inp-box">
                    ...
                    <select class="province select imp" id="bid" name="bid" style="min-width:200px">
                        <option value="">请选择</option>
            ...
            <li>
                <div class="form-inp-box">
                    ...
                    <input type="radio" name="signatureType" value="0" checked="checked" id="signature_type1">绑定签名
                     <textarea  id="signature" class="addNum-text" maxlength="" 
                     style="border: 1px solid #a9a9a9;padding: 3px;height: 40px;"name="signature"></textarea>
            ...
            <li>
                <div class="form-inp-box">
                    <span>IP地址：</span><input style="width:520px" class="inp-inp" type="text" name="firmIp" id="firmIp" placeholder=""/>
                </div>
            </li>
            ...
            <li style="text-align:center">
                <div class="inp-box inpt-box-btn">
                    ...
                    <input style="margin-left:10px" class="f-btn r-btn" type="reset" value="重  置">
                </div>
            </li>
        </ul>
    </form>
