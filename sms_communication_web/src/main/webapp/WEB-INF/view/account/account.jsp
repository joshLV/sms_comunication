        ...
        <div class="com-menu inp-menu">
            ...
            <div class="inp-box" style="display: none;" id="tdDiv">
                ...
                <select id="i_aisleType" name="aisleType">
                    <option value="">请选择</option>
                    <c:forEach var="item" items="${smsAisleGroup}" varStatus="status">
            ...
            <div class="modal-body">
                <form id="cz_merge_form" method="post"
                    ...
                    <div class="awcont">
                        ...
                        <div class="inp-box ">
                            <span>操作类型： </span>
                            <select id="type" name="type" style="min-width: 100px;">
                                <option value="">请选择</option>
...
<div class="modal fade" id="sureModel">
    <div class="modal-dialog modal-sm" style="margin-top: 18%;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"
                        aria-label="Close">
    ...
    <div class="modal-dialog awl">
        <div class="modal-content">
            ...
            <p class="aw-newcontent">
                <span class="aw-new">确认是否<span id="btnupdate"></span>账号？</span>
            </p>
