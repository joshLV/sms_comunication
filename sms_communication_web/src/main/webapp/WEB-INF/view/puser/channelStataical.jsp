...
<div>
	...
	<div class="com-content">
		<div  style="text-align:center;">
          ...
          <div class="inp-box">
          	<input class="f-btn" value="查询" type="button" id="search_btn"  />
          	<input class="f-btn" value="刷新" type="button" id="refrash_btn" />
          	<input class="f-btn" value="导出" type="button" id="export_btn"  />
          </div>
