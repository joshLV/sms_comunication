            ...
            <div class="modal-body">
                <form id="upload_form" method="post"
                    ...
                    <div class="model-cont channegroup">
                        <div class="inp-box">
                            <span> 通道名称：</span> <input class='inp-box-inp model-inp imp' id="i_name" name="name"
                                                       type="text">

                            <span>长短信计费：</span><input class='inp-box-inp model-inp imp' id="smsLength" name="smsLength"
                        ...
                        <div class="inp-box" style="text-align:right;width:481px">
                            <span>售价设定：</span>
                        ...
                        <div class="inp-box">
                            <span>描述：</span> <input class='inp-box-inp mod-inp' id="i_awardMoney" name="awardMoney"
                                                    type="text">
                        </div>
                        <br class="iebr"/>
                        <div class="inp-box">
                            <span>公告：</span><textarea class="dxcontent-xg-txt" style="width: 434px;height: 70px;" id="notice" name="notice"> 
                                                    
                                               </textarea>
                        </div>
                        <br class="iebr"/>
                        <div class="inp-box">
                            <span>提示：</span><textarea class="dxcontent-xg-txt" style="width: 434px;height: 90px;" id="hint" name="hint"> 
                                                    
                                               </textarea>                           
                        </div>
                        <br class="iebr"/>
                        <div class="inp-box">
                            <span>签名：</span> <input class='inp-box-inp mod-inp' id="signature" name="signature"
                                                    type="text">
                        </div>
                    </div>
