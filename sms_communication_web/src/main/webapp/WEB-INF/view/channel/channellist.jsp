        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="upload_form" method="post"
                    ...
                    <div class="model-cont">
                        ...
                        <div class="inp-box">
                            <span> 通道名称：</span> <input class='inp-box-inp model-inp' id="i_name" name="name"
                                                       type="text">
                            <span>通道状态：</span> <select  id="i_state" name="state">
                            <option value="">请选择</option>
                            <option key="1" value="1">启用</option>
                            <option key="2" value="2">停用</option>
                            <option key="3" value="3">自动停用</option>
                        ...
                        <div class="inp-box">
                            <span>通道成本：</span>
                            <input class="inp-box-inp" type="text" id="money" name="money"/>元/条
                        </div>
                        ...
                        <div class="inp-box">
                            <span>通道公司名称：</span>
                            <select class="province select imp" id="i_smsAisleKey"
                                    name="smsAisleKey">
                                <option value="">请选择</option>
                    ...
                    <hr/>
                    <div class="model-cont" style="text-align:right">
                        <div id="aisledata">
                            <!-- <div class="form-group">
                        <label for="apk_version" class="col-sm-3 control-label">通道成本价</label>
                        <div class="col-sm-5">
