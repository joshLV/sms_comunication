...
<input id="startInput" type="hidden" value="${startInput}"/>
<input id="endInput" type="hidden" value="${endInput}"/>
<input id="sendType1" type="hidden" value="${sendType}"/>
...
<div class="content-box" style="text-align:center;">
    ...
    <div class="inp-box">
        ...
        <select id="sendType">
            ...
            <option value="-1" style="display:none;">发送中</option>
            <option value="-2" style="display:none;">已发送</option>
    ...
    <div class="inp-box">
        ...
        <input type="button"  class="f-btn" onclick="back();"
           value="返 回"/>
    ...
    <div class="com-table-box" style="padding-left:10px;color:#4284DA;text-align:left;font-size:12px">
        ...
        <span id="today_state" style="display: none;">
