...
<div class="h-title" style="width:910px; margin-left:21px;">
    账号：<span class="u-n-box">${user.email}</span> &nbsp;&nbsp;短信数量：<span class="u-num">${surplusNum}</span>条
</div>
<div class="tab-box">
    <table class="dzd-table">
        <tr class="addNum-box">
            ...
            <td class="tab-content">
                ...
                <button class="addNum-btn" type="button" id="btn_addPhone"><p style="margin-top:-6px;">添  加</p></button>
        ...
        <tr>
            ...
            <td style="vertical-align:top;">
                <ul style="margin-bottom: 37px;">             
                	 <li>&middot;支持导入 txt 和 Excel 格式号码文件，纵向每行一个手机号码；</li>
        ...
        <tr>
            ...
            <td rowspan="2" style="vertical-align:top;position:relative;top:1px;">
               ...
               <p  class="snotice" > </p>
               <input type="hidden" id="hint" value="${smsAisleGroup.hint}"/>
            </td>
        </tr>
        <tr>
            <td>发送方式</td>
            <td>
                ...
                <div class="sendbtn-box">
                    <input type="button" class="f-btn" value="确  定" id="sendsms-btn">
                    <input type="button" class="f-btn" value="重  置" style="margin-left:10px"
                           onclick="textclear()">
                </div>
                ...
                <ul class="alwd-upload-inp">
                    <li>
                        <form id="uploadFile" method="post" class="flex-c" enctype="multipart/form-data"
                            ...
                            <input type='button' class="f-btn" value='浏览...' id="upBtn"
                ...
                <div class="modal-body" style="text-align:center;padding-top:0px">
                    ...
                    <ul class="alwd-upload-inp yzmdb" style="text-align:left;width:220px;margin:0 auto;">
                        <li>
                   		...
                   		<div style="text-align: left;width: 300px;margin: 0 auto;margin-top: 20px;">
                   		<p>提示：</p>
                        	<p>1、实时群发50条以上，需手机验证码；</p>
                        	<p>2、如果手机收不到验证码短信，请返回选择定时发送。</p>
                        	</div>
