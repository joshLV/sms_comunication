                    ...
                    <table class="helpbox">
                   		...
                   		<tr>
                            ...
                            <td style="text-align: left;">
                                <input id="oldPwd"   type='password' class='inp-inp imp' placeholder="" maxlength="12"
                                       />
						...
						<tr>
                            ...
                            <td style="text-align: left;">
                                <input type="password" id="newPwd"  type='password' class='inp-inp imp' placeholder="" maxlength="12"
                                       />
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <input id="newPwd2"  onblur="return checkPass();" type='password' class='inp-inp imp' maxlength="12"
                                       />
